<div class="text-center">
    <form method="post" class="" locale="ENGLISH" action="Co-Parenting Plan Template.php">
        ...
        <div id="page1" class="card p-4">
            ...
            <input type="text" class="" name="partyAFirst" placeholder="First Name" data-placeholder-original="Full Legal Name">

            <label class="" hide="true" data-dm->Last Name</label>
            <input type="text" class="" name="partyALast" placeholder="Last Name" data-placeholder-original="Full Legal Name">


            <label data-dm->Your Address</label>
            <textarea name="partyAStreet" class="" placeholder="Street Address, Apt, City, State, Zip Code" data-placeholder-original="Street Address, Apt, City, State, Zip Code">
            </textarea>

            <label data-dm->Your Cell Phone No.</label>
            <input type="tel" name="partyACell" placeholder="808-888-8888" class="" data-placeholder-original="808-888-8888">


            <label data-dm->Home Phone No.</label>
            <input type="tel" name="partyAHome" placeholder="">


            <label class="" hide="true" data-dm->Your Email</label>
            <input type="email" name="partyAEmail" class="" placeholder="Your Email Address" data-placeholder-original="Your Email Address">


            <label class="" hide="true" data-dm->Last 4 Digits of Social</label>
            <input type="text" name="paryASocial" placeholder="Last 4 Digits of Social Security Number" class="" data-placeholder-original="Last 4 Digits of Social Security Number">


            <label data-dm->Your Date of Birth</label>
            <input type="date" class="" lang="undefined" placeholder="" date_format="mmddyyyy" name="partyABirthday">

            <label data-dm->Your Place of Birth</label>
            <input type="text" name="partyABirthplace" class="" placeholder="State or Country" data-placeholder-original="State or Country">
