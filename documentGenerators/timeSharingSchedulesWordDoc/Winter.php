...
class Winter {
    public function get_split(string $parentAFirst, string $parentBFirst): string {
      ...
      <w:r>
        <w:t>. In odd years, $parentAFirst shall have the Child(ren) during the first half of the break, to include Christmas Eve and Christmas Day, and $parentBFirst shall have the Child(ren) during the second half of the break, to include New Year’s Eve and
          New Year’s Day. In even years, $parentBFirst shall have the Child(ren) during the first half of the break, to include Christmas Eve and Christmas Day, and $parentAFirst shall have the Child(ren) during the second half of the break, to include New
    ...
    public function get_split_break_holidays(string $parentAFirst, string $parentBFirst, string $christmas_start, string $christmas_end, string $newYears_start, $newYears_end): string {
      ...
      <w:r>
        <w:t xml:space='preserve'>In even years, $parentAFirst shall have the first half of Winter Break to include Christmas Eve and Christmas Day, and $parentBFirst shall have the second half to include New Year’s Eve and New Year’s Day.  In odd years, $parentBFirst shall have the first half of Winter Break to include Christmas Eve and Christmas Day and $parentAFirst shall have the second half, to include New Year’s Eve and New Year’s Day.  During their time, either parent may elect to travel with the Child(ren).  </w:t>
      </w:r>
      ...
      <w:r>
        <w:t xml:space='preserve'> the custodial parent is not traveling, the non-custodial parent shall have the opportunity to spend time with the children on Christmas Day between $christmas_start am/pm and $christmas_end am/pm and New Year’s Day between $newYears_start am/pm and $newYears_end am/pm.</w:t>
      </w:r>
    </w:p>";
    }
}
